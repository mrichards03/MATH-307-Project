...
Let $P = Q_kQ_k$, Then $A_{k+1} = PAP^{-1}$ \\
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{table}[H]
        \begin{tabular}{|c|c|c|}
            ...
            \hline
            5 & 39.95006242197253 & \includegraphics[width=0.2\textwidth]{Q2-2/compressed_k5.jpg} \\
            \hline
            10 & 19.975031210986266 & \includegraphics[width=0.2\textwidth]{Q2-2/compressed_k10.jpg} \\
            \hline
            40 & 4.9937578027465666 & \includegraphics[width=0.2\textwidth]{Q2-2/compressed_k40.jpg} \\
            \hline
            60 & 3.329171868497711 & \includegraphics[width=0.2\textwidth]{Q2-2/compressed_k60.jpg} \\
            \hline
        \end{tabular}        
